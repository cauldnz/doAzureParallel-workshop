...
stop("Please provide a unique container name below")
inputContainerName <- "<your container name>"
...
# Create the cluster
cluster <- makeCluster("cluster-resourcefiles.json", resourceFiles = resource_files)
